...
Retorna todos os candidatos com as suas formações.
...
Retorna o candidato com as suas formações e candidaturas.
...
Mesmos campos do criar, todos opcionais. Se enviar uma nova `foto`, a anterior é removida do Cloudinary.
